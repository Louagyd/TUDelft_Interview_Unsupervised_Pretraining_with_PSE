...
def save_images(images, labels, name = "images"):
...
if __name__ == "__main__":
    ...
    images_unlabeled = read_all_images(UNLABELED_PATH)

    # save images to disk
    save_images(images, labels, "train")
    save_images(images_test, labels_test, "test")
    save_images(images_unlabeled, None, "unlabeled/unlabeled")
